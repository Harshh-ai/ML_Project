...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("num pipeline and cat pipeline created")
    ...
    def initial_data_transformation(self,train_path,test_path):
        try: 
            ...
            input_feature_names=['reading_score','writing_score']
            input_feature_train_df=train_df.drop(columns=[target_feature_name])
